import Preprocessing_T_J as pr
import os
...
triton = pr.Preprocessing_Triton_James(path, alarm_name, del_cols, intended_cols, expected_cols, cols_to_fix, deviation_cols, min_cols)
